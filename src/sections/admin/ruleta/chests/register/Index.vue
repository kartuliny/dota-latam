...
import { StoreChestParams, StoreChestUseCase } from '@/modules/admin/chest/application/chest/StoreChestUseCase';
...
const chest = ref<StoreChestParams>({
    name: '',
    showDropRate: false,
...
const register = async () => {
    try {
        await StoreChestUseCase.invoke(chest.value);
