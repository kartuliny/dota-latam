...
onMounted(async() => {
    ...
    steamUrl.value = socketStore.userData.tradeUrl;
})
...
<template>
    <Modal class="w-11/12 md:w-max" :showFooter="false" @close="setingStore.toggleShowSteamTradeModal()">
        <template #title>
        ...
        <div class="modal__footer">
            <div class="d-flex justify-evenly pt-12">
